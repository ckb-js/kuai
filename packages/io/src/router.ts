...
function makeRoute(options: { path: Path; middleware: Middleware<RouterContext>; method: Method }): Route {
...
export class KuaiRouter {
  ...
  public get(path: Path, middleware: Middleware<RouterContext>): this {
    this.routes.push(makeRoute({ path, method: 'GET', middleware }))
    return this
  }

  public post(path: Path, middleware: Middleware<RouterContext>): this {
    this.routes.push(makeRoute({ path, method: 'POST', middleware }))
    return this
  }

  public put(path: Path, middleware: Middleware<RouterContext>): this {
    this.routes.push(makeRoute({ path, method: 'PUT', middleware }))
    return this
  }

  public delete(path: Path, middleware: Middleware<RouterContext>): this {
    this.routes.push(makeRoute({ path, method: 'DELETE', middleware }))
    return this
  }

  public patch(path: Path, middleware: Middleware<RouterContext>): this {
    this.routes.push(makeRoute({ path, method: 'PATCH', middleware }))
    return this
  }

  public head(path: Path, middleware: Middleware<RouterContext>): this {
    this.routes.push(makeRoute({ path, method: 'HEAD', middleware }))
    return this
  }

  public options(path: Path, middleware: Middleware<RouterContext>): this {
    this.routes.push(makeRoute({ path, method: 'OPTIONS', middleware }))
    return this
  }
